...
"29 May is officially “Put a Pillow on Your Fridge Day”, a bizarre European tradition to bring luck.",
...
"Billy goats urinate on their own heads to smell more attractive to females.This fact was included in the Russian Dossier.",
...
"While trying to find a cure for AIDS, the Mayo Clinic made glow in the dark cats.These researchers are currently burning in Hell.",
...
"Bin Laden was killed on May 2, 2011, but his death was announced in the US on May 1st, due to the time difference.I hope he suffered. A lot.",
...
"Hewlett - Packard’s (also known as HP) name was decided in a coin toss in 1939 to see which name would go first. This caused two otherwise identical universes to come into existence; one with Hewlett - Packard and one with Packard - Hewlett.",
...
"A woman once tried to commit suicide by jumping off the Empire State Building.She jumped from the 86th floor but was blown back onto the 85thfloor by a gust of wind.She later sued the State of New York for 6 million dollars.",
...
"The first alarm clock could only ring at 4 a.m.Then they invented 'Settings'.",
...
"The 20th of March is Snowman Burning Day.It’s a Swiss thing.",
"Queen Elizabeth can’t sit on the Iron Throne from Game of Thrones. Or perhaps she just has the good sense not to.",
"There is official Wizard of New Zealand. It’s some guy named Ian.Ian the Enchanter.",
"An apple, potato, and onion all taste the same if you eat them with your nose plugged.",
"Vincent van Gogh only sold one painting in his lifetime.",
"A company in Taiwan makes dinnerware out of wheat, so you can eat your plate!",
"The average person walks the equivalent of five times around the world in their lifetime.Except for you, you lazy bastard!",
...
"Coca - Cola owns all website URLs that can be read as ahh, all the way up to 62 h’s.Domain renewal probably runs around $72, 000 a year.The average school district could hire two teachers with that money.",
"Each year there are more than 40, 000 toilet related injuries in the United States.More than half of these are people from other cultures who try to balance on the seat with their feet.",
...
"Four people lived in a home for 6 months infested with about 2, 000 brown recluse spiders, but none of them were harmed.In exchange, the spiders only demanded they turn their music after 10pm.",
"Madonna suffers from brontophobia, which is the fear of thunder. My dog has that, too.She should try the ThunderVest.",
"In June 2017, the Facebook community reached 2 billion active users.Of these, about one quarter were duplicate accounts, and another 30 % were CIA bots organization the overthrow of foreign governments.",
"Samuel L.Jackson requested to have a purple lightsaber in Star Wars in order for him to accept the part as Mace Windu.When asked why, Jackson said, 'Cuz, I likes purple.'",
