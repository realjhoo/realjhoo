// This script is copyright (c) 2019
...
function funFact(funFactIndex) {
    ...
    var funFacts = [
        ...
        "Billy goats urinate on their own heads to smell more attractive to females. See also: Russian Dossier.",
        "The inventor of the Frisbee was cremated and made into a Frisbee after he died. He was later lost by his dog in the park near his home.",
        ...
        "Crocodiles can’t stick out their tongues, but alligators can.",
        ...
        "Los Angeles’s full name is “El Pueblo de Nuestra Senora la Reina de los Angeles de Porciuncula.” Due to fear of lawsuits, the city plans to officially shorten its name to “Porciuncula, California” in 2025.",
        "The Twitter bird actually has a name – Larry. Larry Bird. I see what they did there.",
        "Octopi have four pairs of arms. Obviously",
        "In the popular sitcom, Parks and Recreation, the writers had no idea Nick Offerman was a talented saxophone player when they wrote the Duke Silver plot line. I have no idea what that means.",
        ...
        "The first alarm clock could only ring at 4a.m. Then they invented 'Settings'.",
        ...
        "In June 2017, Facebook reached 2 billion active users. Of these, about one quarter were duplicate accounts, and another 30% were CIA bots organization the overthrow of foreign governments. And the rest were elderly women posting pics of their cats",
        "Samuel L.Jackson demanded a purple lightsaber in Star Wars before he would accept the part as Mace Windu. When asked why, Jackson said, 'Cuz, I likes purple.'",
        ...
        "During your lifetime, you will spend around thirty-eight days brushing your teeth. But your dentist will insist it wasn’t enough.",
...
// =-=-=-=-=-=-=-=-=-= This function prints to the DOM =-=-=-=-=-=-=
...
var theFunFact = "<p>" + funFact(funFactIndex) + "</p>";

var insertFunFact = document.getElementById('funFactDiv');
